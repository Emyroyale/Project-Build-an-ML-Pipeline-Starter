...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact",
        type=str,
        help="Fully-qualified name for the input artifact to be cleaned",
        required=True
    )
    ...
    parser.add_argument(
        "--min_price",
        type=float,
        help="Minimum price to consider for a valid data point",
        required=True
    )
    ...
    parser.add_argument(
        "--max_price",
        type=float,
        help="Maximum price to consider for a valid data point",
        required=True
    )
